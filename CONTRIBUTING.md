...
If unique, [open an issue](https://github.com/kleister/kleister-desktop/issues) and answer the questions so we can understand and reproduce the problematic behavior.
